...
11. 필요하면 `qa-agent`를 사용해 체크리스트 방식으로 정리한다.
12. 수정이 필요하면 다시 적절한 Skill 또는 Agent로 되돌린다.

(8~10: 과거 대화 마이닝 상위 누락 신호 반영 — [`docs/agent/rule-candidates.md`](../../docs/agent/rule-candidates.md))
