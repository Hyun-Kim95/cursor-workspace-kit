...
에이전트는 [`kit-work-log`](../../shared/skills/kit-work-log/SKILL.md) 스킬을 따른다. 채팅 `/` 입력 시 **`kit-work-log`** 는 스킬 항목으로 자동완성에 뜬다. 상세 변경 설명이 필요하면 [`document-change`](../../shared/skills/document-change/SKILL.md) 섹션을 참고해 보강한다.
